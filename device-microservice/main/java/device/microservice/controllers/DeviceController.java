...
public class DeviceController {
    ...
    public ResponseEntity<MessageResponse> addDevice(@RequestBody AddDeviceRequest addDeviceRequest) throws JsonProcessingException {
        ...
        System.out.println(objectMapper.writeValueAsString(device));
            messageSender.sendMessage(objectMapper.writeValueAsString(device));
